...
9. [Web UI：路由、状态呈现与契约缺口](web-ui.md)：KM-25 交付记录——`web/` 工程（Svelte + TypeScript + Vite + shadcn-svelte，FR-14.4）、SSE 事件枢纽（`GET /api/v1/events`，FR-14.1/14.2）、FR-14.5 四组状态呈现的落点、本片发现的后端契约缺口与未验证清单。
